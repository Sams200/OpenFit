...
import org.openfit.util.OneRepMaxCalculator
...
class DataHelper @Inject constructor(
     ...
     *  1. Retrieves the latest user’s [org.openfit.db.entity.Measurement.bodyWeight] at each [org.openfit.db.entity.Workout.completed] date.
