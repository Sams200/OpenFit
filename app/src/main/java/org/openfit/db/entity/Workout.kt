 ...
 * @property title The title of the workout visible to the user. The user can modify it in [org.openfit.ui.screens.workout.WorkoutScreen]
 * and [org.openfit.ui.screens.editWorkout.EditWorkoutScreen]
 * @property notes A user note about the routine or workout. The user can modify it in [org.openfit.ui.screens.workout.WorkoutScreen]
 *  * and [org.openfit.ui.screens.editWorkout.EditWorkoutScreen]
 * @property state It indicates whether the workout is a workout, routine, archived or in the library of workouts.
 * When it is set as `ROUTINE`, it will be displayed as a playable routine in the [org.openfit.ui.screens.home.HomeScreen]
 * and the info in [org.openfit.ui.screens.infoWorkout.InfoWorkoutScreen] will be shown differently.
 ...
 * [org.openfit.services.WorkoutService]'s stopwatch during a workout session.
 ...
 * finished in the [org.openfit.ui.screens.workout.WorkoutScreen].
 */
