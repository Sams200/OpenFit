...
/**
 * This data class stores exercises as parsed from `res/raw/exercises.json`. The dataset in provided by [org.openfit.db.repository.DatasetRepository]
 ...
 * @property force The [org.openfit.enums.exercise.Force] type applied during the exercise. Acceptable values are defined in the JSON schema.
 * @property level The difficulty [org.openfit.enums.exercise.Level] of the exercise. Acceptable values are defined in the JSON schema.
 * @property mechanic The exercise [org.openfit.enums.exercise.Mechanic]. Acceptable values are defined in the JSON schema.
 * @property equipment The [org.openfit.enums.exercise.Equipment] required for the exercise. Acceptable values are defined in the JSON schema.
 * @property primaryMuscles List of primary [org.openfit.enums.exercise.Muscle]s involved in the exercise. Acceptable values are defined in the JSON schema.
 * @property secondaryMuscles List of secondary [org.openfit.enums.exercise.Muscle]s involved in the exercise. Acceptable values are defined in the JSON schema.
 * @property instructions Step-by-step instructions detailing how to perform the exercise.
 * @property category The [org.openfit.enums.exercise.Category] of the exercise. Acceptable values are defined in the JSON schema.
