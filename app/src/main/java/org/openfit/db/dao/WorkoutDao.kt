...
import org.openfit.db.relations.ExerciseWithSets
...
interface WorkoutDao {
    /**
     * Returns a flow that emits a stream of [org.openfit.db.entity.Workout]s filtered by [state]
     */
    ...
    /**
     * Returns a flow list [org.openfit.db.relations.WorkoutWithExercisesAndSets]s filtered by [state].
    ...
    /**
     * Retrieves the list of [org.openfit.db.relations.ExerciseWithSets] associated with a specific workout.
    ...
    /**
     * It provides all [WorkoutWithExercisesAndSets] having the passed [org.openfit.db.entity.ExerciseDC] in [Exercise] and
     * the passed [state]
     */
    @Transaction
    @Query(
