...
package org.openfit.util

import android.content.Context
import android.content.pm.PackageManager
import android.os.Build
import org.openfit.enums.supporter.SignatureVerificationResult
import org.openfit.enums.supporter.SupporterVerificationResult
import org.openfit.util.SupporterVerifier.PUBLIC_KEY_STRING
...
object SupporterVerifier {
    private const val COMPANION_PACKAGE_NAME = "org.openfit.companion"
        ...
        return runCatching {
            val appSignatures =
                when (val result = getAppSignatures(context, context.packageName)) {
                    SignatureVerificationResult.NoSignatureFound -> return SupporterVerificationResult.OPENFIT_APP_SIGNATURE_ERROR
                    SignatureVerificationResult.PackageNotFound -> return SupporterVerificationResult.OPENFIT_APP_NOT_FOUND
